...
#pragma config(Sensor, I2C_1,  encLeftFront10, sensorNone)
#pragma config(Sensor, I2C_2,  encShooterLeft7B, sensorNone)
#pragma config(Sensor, I2C_3,  encLeftBack6,   sensorNone)
#pragma config(Sensor, I2C_4,  endBackRight5,  sensorNone)
#pragma config(Sensor, I2C_5,  encShooterRight2, sensorNone)
#pragma config(Sensor, I2C_6,  encRightFront1, sensorNone)
...
//--------------------Button Mapping--------------------//
//Drive axis
#define joyDriveA Ch3 //First axis for the drive joysticks
...
task autonomous() {
	...
	while (bIfiAutonomousMode && !bIfiRobotDisabled && !SensorValue[autonJumper]) {
		...
		else if (state==1 && time1[T1] > 650) {state=2; ClearTimer(T2);}
